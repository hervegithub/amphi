...
var routes = [
    ...
    {
        path: 'register-step2',
        loadChildren: function () { return __webpack_require__.e(/*! import() | register-step2-register-step2-module */ "register-step2-register-step2-module").then(__webpack_require__.bind(null, /*! ./register-step2/register-step2.module */ "./src/app/register-step2/register-step2.module.ts")).then(function (m) { return m.RegisterStep2PageModule; }); }
    },
    {
        path: 'register-step3',
        loadChildren: function () { return __webpack_require__.e(/*! import() | register-step3-register-step3-module */ "register-step3-register-step3-module").then(__webpack_require__.bind(null, /*! ./register-step3/register-step3.module */ "./src/app/register-step3/register-step3.module.ts")).then(function (m) { return m.RegisterStep3PageModule; }); }
    },
    {
        path: 'terminer',
        loadChildren: function () { return __webpack_require__.e(/*! import() | terminer-terminer-module */ "terminer-terminer-module").then(__webpack_require__.bind(null, /*! ./terminer/terminer.module */ "./src/app/terminer/terminer.module.ts")).then(function (m) { return m.TerminerPageModule; }); }
    },
    {
        path: 'home',
...
module.exports = __webpack_require__(/*! /Users/nhy/Documents/GitHub/amphi/src/main.ts */"./src/main.ts");
