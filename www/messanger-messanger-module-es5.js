...
var MessangerPageRoutingModule = /** @class */ (function () {
    function MessangerPageRoutingModule() {
    }
    ...
    return MessangerPageRoutingModule;
}());
...
var MessangerPageModule = /** @class */ (function () {
    function MessangerPageModule() {
    }
...
var MessangerPage = /** @class */ (function () {
    function MessangerPage(router) {
        this.router = router;
        this.messages = [
            {
                uid: 1,
    ...
    MessangerPage.prototype.goTomessagerie = function () {
        this.router.navigateByUrl('home/messagerie');
    };
    MessangerPage.prototype.ngOnInit = function () {
    };
    MessangerPage.ctorParameters = function () { return [
...
//# sourceMappingURL=messanger-messanger-module-es5.js.map