...
var TeachersListPageRoutingModule = /** @class */ (function () {
    function TeachersListPageRoutingModule() {
    }
    ...
    return TeachersListPageRoutingModule;
}());
...
var TeachersListPageModule = /** @class */ (function () {
...
var TeachersListPage = /** @class */ (function () {
    function TeachersListPage(router, http) {
        this.router = router;
        this.http = http;
        this.listes = [];
        this.slideOpts = {};
        ...
        this.http.get('http://localhost:3000/api/teachers', {}).subscribe(function (data) {
            console.log(data); // data received by server
        });
    }
    TeachersListPage.prototype.navigateToSigleTeacher = function () {
        this.router.navigateByUrl('home/single-profil');
    };
    TeachersListPage.prototype.ngOnInit = function () {
    };
    TeachersListPage.ctorParameters = function () { return [
...
//# sourceMappingURL=teachers-list-teachers-list-module-es5.js.map