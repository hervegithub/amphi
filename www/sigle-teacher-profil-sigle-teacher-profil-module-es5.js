...
var SigleTeacherProfilPageRoutingModule = /** @class */ (function () {
    function SigleTeacherProfilPageRoutingModule() {
    }
    ...
    return SigleTeacherProfilPageRoutingModule;
}());
...
var SigleTeacherProfilPageModule = /** @class */ (function () {
    function SigleTeacherProfilPageModule() {
    }
    ...
    return SigleTeacherProfilPageModule;
}());
...
var SigleTeacherProfilPage = /** @class */ (function () {
    function SigleTeacherProfilPage(route) {
        this.route = route;
        this.slideOpts = {};
    ...
    SigleTeacherProfilPage.prototype.ngOnInit = function () {
    };
    SigleTeacherProfilPage.prototype.goToMessage = function () {
        this.route.navigateByUrl('home/messagerie');
    };
    SigleTeacherProfilPage.ctorParameters = function () { return [
...
//# sourceMappingURL=sigle-teacher-profil-sigle-teacher-profil-module-es5.js.map