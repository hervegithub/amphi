...
const routes = [
    ...
    {
        path: 'register-step2',
        loadChildren: () => __webpack_require__.e(/*! import() | register-step2-register-step2-module */ "register-step2-register-step2-module").then(__webpack_require__.bind(null, /*! ./register-step2/register-step2.module */ "./src/app/register-step2/register-step2.module.ts")).then(m => m.RegisterStep2PageModule)
    },
    {
        path: 'register-step3',
        loadChildren: () => __webpack_require__.e(/*! import() | register-step3-register-step3-module */ "register-step3-register-step3-module").then(__webpack_require__.bind(null, /*! ./register-step3/register-step3.module */ "./src/app/register-step3/register-step3.module.ts")).then(m => m.RegisterStep3PageModule)
    },
    {
        path: 'terminer',
        loadChildren: () => __webpack_require__.e(/*! import() | terminer-terminer-module */ "terminer-terminer-module").then(__webpack_require__.bind(null, /*! ./terminer/terminer.module */ "./src/app/terminer/terminer.module.ts")).then(m => m.TerminerPageModule)
    },
    {
        path: 'home',
